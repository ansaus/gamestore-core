...
return [
    ...
    */
    ...
    'catalog' => [
        /*
        | TTL кеша витрины. Остаток здесь заведомо чуть устаревший, и это
        | безопасно: точная правда проверяется в момент выдачи, а расхождение
        | приводит к восстановимому out_of_stock, а не к продаже воздуха.
        */
    ...
    'stub' => [
        ...
        | первые 30 ключей → A, последние 20 → B.
        */
        'key_split' => ['A' => 30, 'B' => 20],
    ],
];
