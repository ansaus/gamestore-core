...
/**
 * Сценарии приёмки 1 и 2 (docs/TASK.md): N параллельных вебхуков по одному заказу.
 *
...
['results' => $results, 'elapsed_ms' => $elapsedMs] = race(storeUrl('/api/webhooks/payment'), $payloads);
...
$status = waitForStatus(
    $orderId,
    ['delivered', 'out_of_stock', 'delivery_failed', 'payment_failed'],
    $waitSec,
);
